...
<body>
    ...
    String sql="select bookid, name,price from cart";
    ...
    {   int bookid=rs.getInt("bookid");
     ...
     String c="Removecart?bid=" +bookid;
    ...
    %>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <h6><span class="price"><i class="fa fa-inr"></i><%=rs.getInt("price") %></span></a></h6>
                            <div class="hover">
                                <a href=<%=k%>>
                        ...
                        <a href=<%=c %> style="color:#696969;">Remove from Cart</a>
                    </div>
  <%
}
%>
