...
<body>
    ...
    <section class="static about-sec">
        <div class="container">
            <h1>About Us</h1>
            <div class="img-sec">
                <img src="images/abpic.png" height=400 alt="about">
...
<p>You can subscribe to our newsletter too. This way we can update you on the latest arrivals in any category you wish for. Just tell us your name and email ID, and we will keep updating you on the newest arrivals in your chosen category. We are largest online book store not only do we have the largest book collection, we also are diligent about updating customers all the time.
</p>
<p>All information is encrypted to ensure privacy of your information. We accept all the major credit cards like MasterCard, VISA, Diners Club, Citibank, AMEX etc. What is more, we also accept cards from a variety of banks like ICICI, Citibank, HDFC, IDBI, iConnect, Centurion Bank and Federal Bank etc. Come visit Bookstore the largest online book store and experience a superior shopping experience.
