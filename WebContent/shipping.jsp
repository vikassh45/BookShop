...
<body>
    ...
    <section class="static about-sec">
        <div class="container">
            ...
            <strong>BookStore Return Policy</strong>
<p>Items shipped from BookStore, can be returned within 30 days of receipt of shipment in most cases. Some books have different policies or requirements associated with them.</p>
            <strong>Seller Return Policy</strong>
<p>When you order from a seller that fulfills and ships its own inventory (also called a third party seller), your return is sent back to the seller instead of BookStore. While most sellers offer a returns policy equivalent to Bookstore policies, some seller returns policies may vary. You can view the return policy of the seller before you purchase an item by viewing the Returns and Refunds Policy section of the seller profile page. </p>
