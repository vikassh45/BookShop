...
<p>Please login here so that we can provide you services according to your choice.</p>
            <div class="form">
                <form action="Login" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            ...
                            <h5>not Registered? <a href="register.jsp">Register here</a></h5>
                        </div>
                    </div>
                </form>
                 <div class="btn-sec">
                     <br><br><hr><a href="adminhome.jsp"> <button class="btn">Click here for admin Login</button></a>
