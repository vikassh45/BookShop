...
<body>
    ...
    String sql="select bookid, name,price from book where name LIKE ? or author LIKE ? ";
    ...
    %>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <h6><span class="price"><i class="fa fa-inr"></i><%=rs.getInt("price") %></span> / <a href=<%=k%>>Buy Now</a></h6>
                            <div class="hover">
                                <a href=<%=k%>>
